...
## Logistic model
```{r}
fit_obj1 <- glm(gi_symptoms ~ gi_condition + sex + race_eth + age_cat + obesity + cancer_factor + cva_comorbidity + sex*gi_condition, data = wave_clean, family = "binomial")
summary(fit_obj1)
```
...
```{r}
## outcome
fit_obj3_outcome <- glm(outcome ~ gi_condition + sex + race_eth + age_cat + obesity + cancer_factor + cva_comorbidity + sex*gi_condition, wave_clean, family = binomial)
...
## intubation
fit_obj3_intuba <- glm(intubation1 ~ gi_condition + sex + race_eth + age_cat + obesity + cancer_factor + cva_comorbidity, wave_clean, family = binomial)
