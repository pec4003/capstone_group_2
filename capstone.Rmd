...
```{r}
## outcome
fit_obj3_outcome <- glm(outcome ~ gi_condition + sex + race_eth + age_cat + obesity + cancer_factor + cva_comorbidity, wave_clean, family = binomial)
summary(fit_obj3_outcome)

## death
fit_obj3_death <- glm(death ~ gi_condition + sex + race_eth + age_cat + obesity + cancer_factor + cva_comorbidity, wave_clean, family = binomial)
summary(fit_obj3_death)

## complication
fit_obj3_comp <- glm(comp_factor ~ gi_condition + sex + race_eth + age_cat + obesity + cancer_factor + cva_comorbidity, wave_clean, family = binomial)
